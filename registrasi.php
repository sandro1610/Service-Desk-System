...
<head>
  ...
  <title>
    Registrasi | Jon Project
  </title>
  <!-- Favicon -->
  <link href="assets/img/icons/ikon.png" rel="icon" type="image/png">
  <!-- Fonts -->
      ...
      <div class="container px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <div class="navbar-collapse-header d-md-none">
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="index.html">
                  <img src="assets/img/icons/ikon.png">
                </a>
              </div>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="registrasi.php">
